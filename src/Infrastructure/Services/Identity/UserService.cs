...
using AutoMapper;
using SecureDoc.Application.Exceptions;
using SecureDoc.Application.Extensions;
...
using SecureDoc.Infrastructure.Specifications;
using SecureDoc.Shared.Constants.Role;
...
namespace SecureDoc.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        private async Task<string> SendVerificationEmail(SecureDocUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "superuser@securedoc.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<SecureDocUser, object>>
                {
