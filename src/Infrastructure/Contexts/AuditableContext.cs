using SecureDoc.Application.Enums;
...
{
    public abstract class AuditableContext : IdentityDbContext<SecureDocUser, SecureDocRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, SecureDocRoleClaim, IdentityUserToken<string>>
    {
