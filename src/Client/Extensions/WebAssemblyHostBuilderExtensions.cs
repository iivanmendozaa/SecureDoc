...
using SecureDoc.Client.Infrastructure.Authentication;
using SecureDoc.Client.Infrastructure.Managers;
using SecureDoc.Client.Infrastructure.Managers.Preferences;
...
using SecureDoc.Client.Infrastructure.Managers.ExtendedAttribute;
using SecureDoc.Domain.Entities.ExtendedAttributes;
using SecureDoc.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace SecureDoc.Client.Extensions
{
